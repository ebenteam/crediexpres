          ...
          <div class="box box-solid">
            ...
            <div class="box-body no-padding">
              <ul class="nav nav-pills nav-stacked">
                ...
                <li><a href="#"><i class="fa fa-circle-o text-yellow"></i>Utilidad Ingresada:<span class="pull-right badge bg-green">{{ number_format($creditos->utilidad_act,0) }}</span></a></li>
                <li><a href="#"><i class="fa fa-circle-o text-light-green"></i>Saldo de Credito:<span class="pull-right badge bg-yellow"> {{number_format($creditos->tot_actual,0)}}</span></a></li>
